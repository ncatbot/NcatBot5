def test_precommit_contains_formatters_and_local_hook():
    ...
    assert 'repo: https://github.com/PyCQA/isort' in data, 'isort 未在 pre-commit 配置中'
    assert 'repo: https://github.com/charliermarsh/ruff-pre-commit' in data, 'ruff 未在 pre-commit 配置中'
