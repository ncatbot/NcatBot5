...
from .abc.plugins import PluginManager, PluginName
...
from .utils.constants import DEBUG_MODE, DEFAULT_MAX_WORKERS, FeatureFlags
        ...
        if event_bus:
            ...
            match FeatureFlags.EVENT_BUS_IMPL:
                ...
                case "NonBlockingEventBus":
                    ...
                    self.event_bus = NonBlockingEventBus(
                        max_workers=max_workers, queue_maxsize=queue_maxsize
                    )
                case None:
