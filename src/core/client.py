...
import os
import logging
from typing import Callable, Optional, TYPE_CHECKING, Any, List, Self, Union, Dict
import threading
import warnings
...
class IMClient:
    ...
    async def send_text_to_group(self, group_id: GroupID, text: str) -> "Message":
        """发送文本到群组"""
        from .IM import TextNode, MessageContent
    ...
    # @unsupported_warning
    async def create_group(self, name: str, initial_members: List[UserID] = None) -> "Group":
        """创建群组"""
